...
export function caracteristicas_localidad() {
  ...
  return [
    new Item({ text: `CARACTERISTICAS GENERALES DE LA LOCALIDAD
    `}).bold().end,
    new Ol([
      ...
      [
        ...
        `).bold().alignment('justify').end,
        new Table([
          ['ANCASH', 'HURAZS', 'INDEPENDEICIA', '102020', 'Localidades', 'Región Geográfica', 'Región Natural', 'Altitud'],
          ['ANCASH', 'HURAZS', 'INDEPENDEICIA', '102020', 'Localidades', 'Región Geográfica', 'Región Natural', 'Altitud'],
          ['ANCASH', 'HURAZS', 'INDEPENDEICIA', '102020', 'Localidades', 'Región Geográfica', 'Región Natural', 'Altitud'],
          ['ANCASH', 'HURAZS', 'INDEPENDEICIA', '102020', 'Localidades', 'Región Geográfica', 'Región Natural', 'Altitud'],
          ['ANCASH', 'HURAZS', 'INDEPENDEICIA', '102020', 'Localidades', 'Región Geográfica', 'Región Natural', 'Altitud'],
      ...
      [
        new Item({ text: `DIAGNÓSTICO DE LA SITUACIÓN ACTUAL
        ` }).bold().end,
        [
          ...
          new Ol([
            [
              new Item({ text: `ÁREA DE ESTUDIO DEL PROYECTO
              ` }).bold().end,
              [
            ...
            [
              new Item({ text: `ÁREA DE INFLUENCIA
              ` }).bold().end,
              [
      ...
      [
        ...
        new Item({ text:`ACCESO AL ÁREA DE ESTUDIO
        `}).bold().end,
        [
      ...
      [
        new Item({ text: `PRINCIPALES ACTIVIDADES ECONÓMICAS
        ` }).bold().end,
        ...
        new Ol([
          [
            new Item({ text: `ACTIVIDAD AGRÍCOLA
            ` }).bold().end,
          ...
          [
            new Item({ text:`ACTIVIDAD PECUARIA
            `}).bold().end,
          ...
          [
            new Item({ text:`ACTIVIDAD ARTESANAL
            ` }).bold().end,
      ...
      [
        [
          new Item({ text:`ASPECTOS CLIMATOLÓGICOS
          `}).bold().end,
          [
        ...
        new Ol([
          [
            new Item({ text:`RECURSOS HÍDRICOS
            `}).bold().end,
            [
          ...
          [
            new Item({ text: `GEOLOGÍA
            `}).bold().end,
            new Ol([
              [
                new Item({ text: `ZONA PUNA
                `}).bold().end,
                [
      ...
      [
        ...
        new Ol([
          [
            new Item({ text: `RESUMEN CASERÍOS BENEFICIADOS
            ` }).bold().end,
            new Ol([
              [
                new Item({ text: `CASERÍOS BENEFICIADOS
                ` }).bold().end,
                [
              ...
              [
                ...
                new Item({ text: `USO DE LA VIVIENDA
                ` }).bold().end,
                [
              ...
              [
                new Item({ text: `MATERIAL DE CONSTRUCCIÓN
                `}).bold().end,
              ...
              [
                new Item({ text: `SERVICIOS BÁSICOS
                ` }).bold().end,
                [
                  ...
                  new Item({text:`Cuadro de resultados de la encuesta a la pregunta enfermedades más comunes hogar
                  `}).end,
                  new Table([
                  ...
                  pdf.ln(),
                  new Item({text:`Fuente Encuesta Socioeconómica Distrito y Anexos - realizado por el consultor de proyectos.
                  `}).alignment('justify').end,
